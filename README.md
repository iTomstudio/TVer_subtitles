...
1. **完整版工具** (`tver_subtitle.py`) - ✅ 已修复并可用
   - 通过TVer API自动获取所有信息
   - 支持三种模式：CLI、批量、交互
   - 自动提取集数信息
   - 推荐用于批量下载

2. **简化版工具** (`tver_subtitle_simple.py`) - 最稳定
   - 直接使用m3u8 URL
   - 无需API认证
   - 适合单个下载
...
```
============================================================
🎬 处理视频: https://tver.jp/episodes/ep8ec3bhfj
============================================================
📌 视频ID: ep8ec3bhfj

🔐 初始化API客户端...
✅ 平台认证成功 (UID: bfda5dc3...)
✅ 获取视频元数据成功: じゃあ、あんたが作ってみろよ 第2话
✅ 获取Streaks配置成功 (包含47个项目)
✅ 获取字幕轨道URL成功
...
============================================================
✅ 字幕下载成功!
📁 保存位置: subtitles/ep8ec3bhfj_02.vtt
📊 文件大小: 35516 字符
============================================================
```
